...
app.get("/user/login", (req, res) => {
  res.sendFile(
    path.join(__dirname, "..", "..", "hosting", "admin", "user-login.html")
  );
});
...
app.get("/user/signup", (req, res) => {
  res.sendFile(
    path.join(__dirname, "..", "..", "hosting", "admin", "user-signup.html")
  );
});
...
app.get("/admin", (req, res) => {
  res.sendFile(
    path.join(__dirname, "..", "..", "hosting", "admin", "admin.html")
  );
});
...
app.get("/login", (req, res) => {
  res.sendFile(
    path.join(__dirname, "..", "..", "hosting", "admin", "login.html")
  );
});
...
app.get("/chatbot", (req, res) => {
  res.sendFile(
    path.join(__dirname, "..", "..", "hosting", "frontend", "voroai-main.html")
  );
});
