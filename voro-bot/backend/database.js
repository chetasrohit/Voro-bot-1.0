...
function initDatabase() {
  return new Promise((resolve, reject) => {
    ...
    db.serialize(() => {
      ...
      // Chat logs table for AI conversations
      db.run(`
        ...
        options: [
          {
            ...
            answer:
              "Our admissions team reviews applications holistically. Contact: admissions@college.edu | Phone: (555) 123-4567 | Visit: admissions.college.edu",
          },
          {
            option_key: "B",
            title: "Campus Tours",
            ...
            answer:
              "We offer daily campus tours at 10 AM and 2 PM. Book online or contact our visitor center. Contact: tours@college.edu | Phone: (555) 123-4568",
          },
        ],
      },
      {
        ...
        options: [
          {
            ...
            answer:
              "Undergraduate tuition is $15,000 per semester. Contact the bursar for payment plans. Contact: bursar@college.edu | Phone: (555) 123-4569",
          },
          {
            option_key: "B",
            title: "Scholarships",
            ...
            answer:
              "We offer merit-based and need-based scholarships. Apply through our portal. Contact: finaid@college.edu | Phone: (555) 123-4570",
          },
        ],
      },
      {
        ...
        options: [
          {
            ...
            answer:
              "We have 5 residence halls with single and shared rooms. Applications open in March. Contact: housing@college.edu | Phone: (555) 123-4571",
          },
          {
            option_key: "B",
            ...
            answer:
              "Visit our off-campus housing portal for listings and roommate matching. Contact: offcampus@college.edu | Phone: (555) 123-4572",
          },
        ],
      },
      {
        ...
        options: [
          {
            ...
            answer:
              "Registration opens 2 weeks before each semester. Use the student portal. Contact: registrar@college.edu | Phone: (555) 123-4573",
          },
          {
            option_key: "B",
            ...
            answer:
              "Every student is assigned an advisor. Schedule appointments through the portal. Contact: advising@college.edu | Phone: (555) 123-4574",
          },
        ],
      },
      {
        ...
        options: [
          {
            ...
            answer:
              "Our career center offers resume reviews, mock interviews, and job fairs. Contact: careers@college.edu | Phone: (555) 123-4575",
          },
          {
            option_key: "B",
            ...
            answer:
              "Free health services for all students. Mental health counseling also available. Contact: health@college.edu | Phone: (555) 123-4576",
          },
        ],
      },
      {
        ...
        options: [
          {
            ...
            answer:
              "We have over 200 student organizations! Visit the student life office to explore. Contact: studentlife@college.edu | Phone: (555) 123-4577",
          },
          {
            option_key: "B",
            ...
            answer:
              "Check our events calendar for concerts, lectures, and social activities. Contact: events@college.edu | Phone: (555) 123-4578",
          },
        ],
      },
    ];
    ...
    getAllTopics(db)
      .then((topics) => {
        ...
        for (const [topicKey, topicValue] of Object.entries(topics)) {
          const sanitizedTopicName = topicValue.name
            .replace(/[^\w\s]/g, "")
            .toLowerCase();
          const mentionsTopic =
            normalized.includes(topicKey) ||
            normalized.includes(sanitizedTopicName);
          ...
          if (mentionsTopic) {
            ...
            const options = Object.entries(topicValue.options)
              .map(
                ([optKey, optValue]) =>
                  `Option ${optKey}: ${optValue.title} - ${optValue.description}`
              )
              .join(" | ");
        ...
        getAllTopics(db).then((allTopics) => {
          const topicNames = Object.values(allTopics)
            .map((t) => t.name)
            .join(", ");
          resolve({
            type: "fallback",
...
// Log user chat with AI
function logUserChat(db, userName, userMessage, botReply) {
  return new Promise((resolve, reject) => {
    db.run(
      `INSERT INTO chat_logs (user_name, user_message, bot_reply) VALUES (?, ?, ?)`,
      [userName || "Anonymous", userMessage, botReply],
      function (err) {
        if (err) {
...
function getUserChats(db) {
  return new Promise((resolve, reject) => {
    db.all(
      `SELECT * FROM chat_logs ORDER BY created_at DESC LIMIT 100`,
      [],
      (err, rows) => {
        if (err) {
          reject(err);
